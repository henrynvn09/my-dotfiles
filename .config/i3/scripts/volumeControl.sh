...
$DIR/notify-send.sh "$volume""      " -t 2000 -h int:value:"$volume" -h string:synchronous:"─" --replace=555
    else
...
$DIR/notify-send.sh "$volume""     " --replace=555 -t 2000
    else
...
$DIR/notify-send.sh "$volume""     ""$bar" -t 2000 -h string:synchronous:"$bar" --replace=555
